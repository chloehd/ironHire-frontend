  ...
  render() {
    return (
      <section className="homepage">
        ...
        <div className="parallax row"><img src="background1.jpg" alt="Unsplashed background img 1" /></div>
        ...
        <div className="container row">
          <div className="section">
            ...
            <div className="row">
              ...
              <div className="col s12 m4">
                <div className="icon-block">
                  <h2 className="center brown-text"><i className="material-icons">business_center</i></h2>
